...
//        };
//        
//        MethodFingerprint classPrint = creator.createClassFingerprint(
//                methodASTs, smaliClassName, addMethods);
//        
//        assert(classPrint.getName().equals(className));
//        
//        List<MethodFingerprint> methodPrints = classPrint.getChildFingerprints();
//
...
//        
//        MethodFingerprint methodprint = new MethodFingerprint();
